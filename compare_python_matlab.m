...
param.ptCloudpathname = 'C:\dev\G3Point_dev\PointCloud\';
...
%% [NOT IN PYTHON] Denoise and decimate point cloud

%% [NOT IN PYTHON] Remove the point that are localized in local minima (multiscale) to ease segmentation and delimitation of grains

%% Rotate and detrend the point cloud if needed
...
%% [NOT IN PYTHON] Show the clean point cloud
...
%% CLUSTER
% BE CAREFULE IN segment_labels.m TO THE LINE isink=find(slope>=0); 
% MIND THE COHERENCY WITH PYTHON
